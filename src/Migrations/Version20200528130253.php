 ...
 */
final class Version20200528130253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE screen_entity ADD definition VARCHAR(255) DEFAULT NULL, DROP defintion, CHANGE size size VARCHAR(255) DEFAULT NULL, CHANGE dpi dpi VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user DROP updated_at, CHANGE first_name first_name VARCHAR(255) DEFAULT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE country country VARCHAR(255) DEFAULT NULL, CHANGE telephone telephone VARCHAR(255) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
    }

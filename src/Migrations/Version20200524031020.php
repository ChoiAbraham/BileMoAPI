 ...
 */
final class Version20200524031020 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE smartphone ADD created_at DATETIME NOT NULL, CHANGE title title VARCHAR(255) DEFAULT NULL, CHANGE rate rate VARCHAR(100) DEFAULT NULL, CHANGE price price INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE first_name first_name VARCHAR(255) DEFAULT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE country country VARCHAR(255) DEFAULT NULL, CHANGE telephone telephone VARCHAR(255) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE smartphone DROP created_at, CHANGE title title VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE rate rate VARCHAR(100) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE price price INT DEFAULT NULL');
        $this->addSql('ALTER TABLE specification CHANGE system_id system_id INT DEFAULT NULL, CHANGE battery_id battery_id INT DEFAULT NULL, CHANGE camera_id camera_id INT DEFAULT NULL, CHANGE dimension_id dimension_id INT DEFAULT NULL, CHANGE divers_id divers_id INT DEFAULT NULL, CHANGE network_id network_id INT DEFAULT NULL, CHANGE performance_id performance_id INT DEFAULT NULL, CHANGE screen_id screen_id INT DEFAULT NULL, CHANGE storage_id storage_id INT DEFAULT NULL');
